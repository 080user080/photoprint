...
class QueueView(QListWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.viewport().setAcceptDrops(True)   # ← ГОЛОВНЕ: viewport теж має приймати
        self.setDropIndicatorShown(True)
        # Встановлюємо фільтр подій на viewport — бо на Windows
        # drag-події йдуть через viewport, а не через сам QListWidget
    ...
    # ------------------------------------------------------------------
    # Event filter — перехоплює drag-події з viewport (Windows fix)
    # ------------------------------------------------------------------
